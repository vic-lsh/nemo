...
module nemo_pipeline_combiner_and_translation #(
...
nemo_pipeline_translation_unit #(
     .N_DATAPATHS(N_DATAPATHS)
) translation_unit_inst (
     .clk(clk)
    ,.rst(rst)
    ...
    ,.nemo_s_in_controlpath_req (demux_s_in_controlpath_req[1])
    ,.nemo_s_in_controlpath_req_valid   (demux_s_in_controlpath_req_valid[1])
    ,.nemo_s_out_controlpath_req_ready  (demux_s_out_controlpath_req_ready[1])

    ,.nemo_m_out_controlpath_resp   (demux_m_out_controlpath_resp[1])
    ,.nemo_m_out_controlpath_resp_valid (demux_m_out_controlpath_resp_valid[1])
    ,.nemo_m_in_controlpath_resp_ready  (demux_m_in_controlpath_resp_ready[1])
);

nemo_pipeline_combiner #(
      .N_DATAPATHS(N_DATAPATHS)
