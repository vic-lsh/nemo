...
controlpath_start_physical_address_addr = "32'h40028"
...
def controlpath_tb(tb: TB_Translator):
    ...
    tb.control_write(controlpath_start_physical_address_addr, "64'h1_0000_0000_0000")

    # set up translation unit
    tb.control_write(pipeline_selector_addr, "32'h0000_8000") # select pipeline 0 with routing to translation unit, datapath doesn't matter
    tb.control_write("32'h0000_0000", "32'h0000_2000") # enable translation 0 -> 0
    tb.control_write("32'h0000_0008", "32'h0000_2001") # enable translation 1 -> 1
    ...
    tb.memory_read ("32'h0000_0400", "'hdeadb33f", 10)
    ...
    tb.memory_read ("64'h1_0000_0000_0000", "'d11", 1)
    #check_pipeline_telem(tb, "32'h10000", "8", "1")
    tb.memory_read ("64'h1_0001_0000_0040", "'h1", 1)
    #check_pipeline_telem(tb, "0", "16", undef)
    tb.memory_read ("64'h1_0000_0000_0080", undef, 1)
    tb.memory_read ("64'h1_0000_0000_0080", "'h0", 1)
    tb.memory_read ("64'h1_0001_0000_0040", "'h0", 1)
    tb.memory_read ("64'h1_0000_0000_0080", "'h0", 1)
    tb.memory_read ("64'h1_0001_0000_0040", "'h0", 1)
    tb.memory_read ("64'h1_0000_0000_0080", "'h0", 1)
    tb.memory_read ("64'h1_0001_0000_0040", "'h0", 1)
    ...
    tb.memory_read ("64'h1_0000_0000_0080", "'h0", 1)
    tb.memory_read ("64'h1_0001_0000_0040", "'h0", 1)
    tb.memory_read ("64'h1_0000_0000_0000", "'h0", 10)

    set_pipeline_config(tb,   added_stall_addr,     "0")
    tb.stall("1000")

    tb.memory_reads(["64'h1_0000_0000_0080", "32'h0000_0400", "64'h1_0000_0000_0080", "64'h1_0000_0000_0080",
        "32'h0000_0400", "32'h0000_0400"], ["'h0", "'hdeadb33f", "'h0", "'h0", "'hdeadb33f", "'hdeadb33f"])

    tb.stall("50")
    tb.memory_read ("64'h1_0000_0000_0000", "'h3", 1)
    tb.memory_read ("64'h1_0000_0004_0100", undef, 1)
